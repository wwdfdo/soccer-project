...
function Worldbg() {
  return (
    <div className="relative h-screen w-full bg-viewportBg4 bg-no-repeat bg-cover bg-bottom ">
      <MouseParallaxContainer>
    ...
    // <div className="relative w-full h-screen bg-stadium2 bg-no-repeat bg-cover bg-center">
    //   {/* <video loop autoPlay muted className="w-full h-screen object-cover">
